...
- **[Decision Guardian GitHub](https://github.com/decispher/decision-guardian)** - Installation & setup
- **[DECISIONS_FORMAT.md](../DECISIONS_FORMAT.md)** - Complete format reference
- **[CONTRIBUTING.md](../CONTRIBUTING.md)** - How to contribute examples

---

**Made with ❤️ by [Ali Abbas](https://github.com/aliabbasjaffri) • Part of [Decispher](https://decispher.com)**
