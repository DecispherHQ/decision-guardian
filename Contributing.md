...
**Project Author**: Ali Abbas ([@aliabbasjaffri](https://github.com/aliabbasjaffri))  
...
```bash
git remote add upstream https://github.com/decispher/decision-guardian.git
```
...
2. **Try the latest version** (`decispher/decision-guardian@v1`)
...
**Author**: Ali Abbas ([@aliabbasjaffri](https://github.com/aliabbasjaffri))  
**Organization**: Decispher  
**License**: MIT
