...
export class CommentManager {
  ...
  // GitHub API limit is 65536 chars
  ...
  private buildFullComment(matches: DecisionMatch[], hash: string): string {
    ...
    comment += `This PR modifies ${matches.length} file(s) protected by architectural decisions.\n\n`;
    ...
    comment += `\n---\n`;
    comment += `*🤖 This alert is generated by [Decision Guardian](https://github.com/decispher/decision-guardian). `;
    comment += `If this is incorrect, please update the decision file or contact your team lead.*\n`;
  ...
  private buildTruncatedCommentWithLimits(matches: DecisionMatch[], hash: string, maxDetailedMatches: number, maxFilesPerDecision: number): string {
    ...
    comment += `<!-- hash:${hash} -->\n\n`;
    comment += `## ⚠️ Decision Context Alert\n\n`;
    comment += `> **Note**: This PR affects **${totalMatches} files** - showing summary due to size limits.\n\n`;
    ...
    comment += `\n---\n`;
    comment += `*🤖 This alert is generated by [Decision Guardian](https://github.com/decispher/decision-guardian). `;
    comment += `Showing ${detailedCount} of ${totalMatches} matches in detail.*\n`;
  ...
  private buildUltraCompactComment(matches: DecisionMatch[], hash: string): string {
    ...
    comment += `<!-- hash:${hash} -->\n\n`;
    comment += `## ⚠️ Decision Context Alert\n\n`;
    comment += `> ⚠️ **Large PR**: This PR affects **${totalMatches} files** across **${byDecision.size} decisions**.\n\n`;
    ...
    comment += `\n---\n`;
    comment += `*🤖 Generated by [Decision Guardian](https://github.com/decispher/decision-guardian). `;
    comment += `Full details truncated due to size limits.*\n`;
...
**Matched**: \`${escapeMarkdown(patternDisplay)}\`  
**Match Type**: ${matchType}  
**Date**: ${escapeMarkdown(decision.date)}

${escapeMarkdown(decision.context)}
